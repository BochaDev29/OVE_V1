...
export const NewFloorModal = ({ onClose, onConfirm }: NewFloorModalProps) => {
    const [name, setName] = useState('');
    const [formatKey, setFormatKey] = useState('A4-landscape');
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-96 shadow-xl">
                <h2 className="text-xl font-bold mb-4">Nueva Planta</h2>
